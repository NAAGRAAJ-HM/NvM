...
FUNC(void, NVM_CODE) module_NvM::InitFunction(
   ...
   if(
      ...
      printf("\nCfgGen_NvM.CfgCanIf.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanIf.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgCanIf.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanIf.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgCanIf.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgCanNm";
      printf("\nCfgGen_NvM.CfgCanNm.bDevErrorDetect                       = %d", CfgGen_NvM.CfgCanNm.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgCanNm.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanNm.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgCanNm.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanNm.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgCanNm.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgCanSm";
      printf("\nCfgGen_NvM.CfgCanSm.bDevErrorDetect                       = %d", CfgGen_NvM.CfgCanSm.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgCanSm.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanSm.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgCanSm.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanSm.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgCanSm.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgCanTp";
      printf("\nCfgGen_NvM.CfgCanTp.bDevErrorDetect                       = %d", CfgGen_NvM.CfgCanTp.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgCanTp.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanTp.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgCanTp.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanTp.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgCanTp.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgCryIf.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCryIf.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgCryIf.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCryIf.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgCryIf.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgEthIf.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgEthIf.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgEthIf.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgEthIf.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgEthIf.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgIpduM.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgIpduM.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgIpduM.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgIpduM.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgIpduM.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgJ1939Tp";
      printf("\nCfgGen_NvM.CfgJ1939Tp.bDevErrorDetect                     = %d", CfgGen_NvM.CfgJ1939Tp.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgJ1939Tp.VersionInfo.u8ArVersionMajor        = 0x%2.2X", CfgGen_NvM.CfgJ1939Tp.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgJ1939Tp.VersionInfo.u8ArVersionMinor        = 0x%2.2X", CfgGen_NvM.CfgJ1939Tp.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionMajor        = 0x%2.2X", CfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionMinor        = 0x%2.2X", CfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionPatch        = 0x%2.2X", CfgGen_NvM.CfgJ1939Tp.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgLinIf.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgLinIf.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgLinIf.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgLinIf.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgLinIf.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgLinTp";
      printf("\nCfgGen_NvM.CfgLinTp.bDevErrorDetect                       = %d", CfgGen_NvM.CfgLinTp.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgLinTp.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgLinTp.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgLinTp.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgLinTp.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgLinTp.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgMemIf.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgMemIf.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgMemIf.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgMemIf.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgMemIf.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgSecOC.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgSecOC.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgSecOC.VersionInfo.u8SwVersionPatch);

      cout<<endl<<endl<<"CfgSokFm";
      printf("\nCfgGen_NvM.CfgSokFm.bDevErrorDetect                       = %d", CfgGen_NvM.CfgSokFm.bDevErrorDetect);
      printf("\nCfgGen_NvM.CfgSokFm.VersionInfo.u8ArVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgSokFm.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgSokFm.VersionInfo.u8ArVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgSokFm.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionMajor          = 0x%2.2X", CfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionMinor          = 0x%2.2X", CfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionPatch          = 0x%2.2X", CfgGen_NvM.CfgSokFm.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgStartUp.VersionInfo.u8ArVersionMajor        = 0x%2.2X", CfgGen_NvM.CfgStartUp.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgStartUp.VersionInfo.u8ArVersionMinor        = 0x%2.2X", CfgGen_NvM.CfgStartUp.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionMajor        = 0x%2.2X", CfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionMinor        = 0x%2.2X", CfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionPatch        = 0x%2.2X", CfgGen_NvM.CfgStartUp.VersionInfo.u8SwVersionPatch);
      ...
      printf("\nCfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8ArVersionMajor     = 0x%2.2X", CfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8ArVersionMajor);
      printf("\nCfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8ArVersionMinor     = 0x%2.2X", CfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8ArVersionMinor);
      ...
      printf("\nCfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8IDInstance         = 0x%2.2X", CfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8IDInstance);
      printf("\nCfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8SwVersionMajor     = 0x%2.2X", CfgGen_NvM.CfgSwcApplFoc.VersionInfo.u8SwVersionMajor);
...
*/
      ...
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8ArVersionMinor           = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8ArVersionMinor);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8IDVendor                 = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8IDVendor);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8IDModule                 = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8IDModule);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8IDInstance               = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8IDInstance);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionMajor           = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionMajor);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionMinor           = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionMinor);
      printf("\nCfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionPatch           = 0x%2.2X", CfgGen_NvM.CfgPduR.VersionInfo.u8SwVersionPatch);
      printf("\nCfgGen_NvM.CfgPduR.Core.Id                                = 0x%4.4X", CfgGen_NvM.CfgPduR.Core.Id);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bUpperModule            = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bUpperModule);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bLowerModule            = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bLowerModule);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCommunicationInterface = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCommunicationInterface);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransportProtocol      = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransportProtocol);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransmit               = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransmit);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransmitTp             = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTransmitTp);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTxConfirmation         = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTxConfirmation);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTxConfirmationTp       = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTxConfirmationTp);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bRxIndication           = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bRxIndication);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bRxIndicationTp         = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bRxIndicationTp);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCancelTransmit         = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCancelTransmit);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCancelReceive          = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCancelReceive);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCopyTxData             = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCopyTxData);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCopyRxData             = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bCopyRxData);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTriggerTransmit        = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bTriggerTransmit);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bReTransmition          = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bReTransmition);
      printf("\nCfgGen_NvM.CfgPduR.Core.aptrClients[0]->bStartOfReception       = %d", CfgGen_NvM.CfgPduR.Core.aptrClients[0]->bStartOfReception);
